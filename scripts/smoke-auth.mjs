...
await page.screenshot({ path: "/tmp/opencode/auth-anonymous.png", fullPage: true })
...
await page.screenshot({ path: "/tmp/opencode/auth-qr.png", fullPage: true })

await page.waitForSelector("text=Connected", { timeout: 8000 })
await page.screenshot({ path: "/tmp/opencode/auth-connected.png", fullPage: true })
